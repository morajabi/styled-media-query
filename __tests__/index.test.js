...
test('expect <Box /> to have matching media style rules', () => {
...
test('expect lessThan("medium") to create Array', () => {
  let tree = renderer.create(css`${generatedDefaultMedia.lessThan("medium")`
    background: red
  `}`).toJSON();
  let testArray = [
    "\n    @media (max-width: ",
  ...
  expect(tree).toEqual(expect.arrayContaining(testArray));
});



test('expect between("medium", "large") to create Array', () => {
  let tree = renderer.create(css`${generatedDefaultMedia.between("medium", "large")`
    background: green;
  `}`).toJSON();
  let testArray = [
    "\n    @media (min-width: ",
...
test('expect greaterThan("large") to create Array', () => {
  let tree = renderer.create(css`${generatedDefaultMedia.greaterThan("large")`
    background: blue;
  `}`).toJSON();
  let testArray = [
    "\n    @media (min-width: ",
...
test('expect greaterThan(320) to create Array', () => {
  let tree = renderer.create(css`${generatedDefaultMedia.greaterThan('320')`
    background: blue;
  `}`).toJSON();
  let testArray = [
    "\n    @media (min-width: ",
...
test('expect greaterThan() to create Array', () => {
  let tree = renderer.create(css`${generatedDefaultMedia.greaterThan('')`
    background: blue;
  `}`).toJSON();
  let testArray = [
    "\n    @media (min-width: ",
...
test('expect defaultBreakpoints to equal sizes', () => {
